        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Room_SeatCount_MinLength", "[SeatCount] >= 0 AND [SeatCount] <=25 ");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Student_Age_MinLength", "[Age] >= 15 AND [Age] <=50 ");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Teacher_Age_MinLength", "[Age] >= 30 AND [Age] <=75 ");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Group_Capacity_MinLength", "[Capacity] >= 0 AND [Capacity] <=22 ");
                    table.ForeignKey(
